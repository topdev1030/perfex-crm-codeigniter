...
<div class="tab-content mtop15">
    <div role="tabpanel" class="tab-pane active" id="email_config">
        ...
        <div class="form-group">
            ...
            <label for="mail_engine"><?= _l('mail_engine'); ?></label><br />
            ...
            <?php } ?>
            <label for="email_protocol"><?= _l('email_protocol'); ?></label><br />
            <div class="radio radio-inline radio-primary">
        ...
        <div class="smtp-fields<?= get_option('email_protocol') == 'mail' ? ' hide' : ''; ?>">
            <div
                ...
                <p>
                    ...
                    <span class="tw-select-all"><?= admin_url('smtp_oauth_microsoft/token'); ?></span>
                </p>
                <div class="form-group">
                ...
                <?php if (!empty(get_option('microsoft_mail_client_id')) && !empty(get_option('microsoft_mail_client_secret'))) { ?>
                    <a href="<?= admin_url('smtp_oauth_microsoft/token'); ?>" class="btn btn-primary">
                        Authenticate
                    </a>
                <?php } else { ?>
                    <div class="alert alert-warning">
            ...
            <div
                ...
                <p>
                    <span class="tw-font-semibold">Redirect URL:</span>
                    <span class="tw-select-all"><?= admin_url('smtp_oauth_google/token'); ?></span>
                </p>
                <div class="form-group">
                    <label for="ClientId">Client Id</label>
                ...
                <?php if (!empty(get_option('google_mail_client_id')) && !empty(get_option('google_mail_client_secret'))) { ?>
                    <a href="<?= admin_url('smtp_oauth_google/token'); ?>" class="btn btn-primary">
                        Authenticate
                    </a>
                <?php } else { ?>
                    <div class="alert alert-warning">
            ...
            <tbody>
                <?php foreach ($queueEmails as $email) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= admin_url('emails/delete_queued_email/' . $email->id); ?>" class="text-danger">
