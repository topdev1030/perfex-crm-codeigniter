...
function app_init_admin_sidebar_menu_items()
{
    ...
    $CI->app_menu->add_sidebar_menu_item('regulation', [
        'collapse' => true, // Allows submenus
        'name' => _l('als_regulation'), // Menu name
        'icon' => 'fa-solid fa-gavel', // Replace with a relevant FontAwesome icon
        'position' => 90, // Adjust position based on your desired order
    ...
    $CI->app_menu->add_sidebar_children_item('regulation', [
        'slug' => 'weapons-list',
        'name' => _l('als_weapons_list_submenu'),
        'href' => admin_url('regulation/weapons_list'),
        'position' => 5, // Position within the Regulation submenu
        'badge' => [],
    ]);
    ...
    $CI->app_menu->add_sidebar_children_item('regulation', [
        'slug' => 'vests-list',
        'name' => _l('als_vests_list_submenu'),
        'href' => admin_url('regulation/vests_list'),
        'position' => 10,
        'badge' => [],
    ]);
    ...
    // $CI->app_menu->add_sidebar_children_item('regulation', [
    //     'slug' => 'non-lethal-equipment',
    //     'name' => _l('als_non_lethal_equipment_submenu'),
    //     'href' => admin_url('regulation/non_lethal_equipment'),
    //     'position' => 15,
    //     'badge' => [],
    // ]);
    ...
    // Ongoing Processes
    // $CI->app_menu->add_sidebar_children_item('regulation', [
    //     'slug' => 'ongoing-processes',
    //     'name' => _l('als_ongoing_processes_submenu'),
    //     'href' => admin_url('regulation/ongoing_processes'),
    //     'position' => 30,
    //     'badge' => [],
    // ]);
    ...
    $CI->app_menu->add_sidebar_children_item('regulation', [
        'slug' => 'reports',
        'name' => _l('als_reports_submenu'),
        'href' => admin_url('regulation/reports'),
        'position' => 45,
        'badge' => [],
    ]);

    // Add this after your vests menu item
    $CI->app_menu->add_sidebar_children_item('regulation', [
        'slug' => 'controlled-equipment-list',
        'name' => _l('als_controlled_equipment_list'),
        'href' => admin_url('regulation/controlled_equipment_list'),
        'position' => 11,
        'badge' => [],
    ]);
    ...
    $CI->app_menu->add_sidebar_children_item('regulation', [
        'slug' => 'processes-list',
        'name' => _l('als_processes_list'),
        'href' => admin_url('regulation/processes_list'),
        'position' => 12,
        'badge' => [],
    ]);
